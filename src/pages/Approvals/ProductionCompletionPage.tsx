// src/pages/Approvals/ProductionCompletionPage.tsx
...
const SCOPE = "production" as const;
...
export default function ProductionCompletionPage() {
  ...
  return (
    <div className="space-y-6">
      <PageMeta title="Üretim Tamamlama" description="Pending kayıtları depoya alma" />
